...
import AlliIconCandidate from '../../img/light/alli/appIcon/alli-icon-candidate.svg';
import AlliIconCopyrighting from '../../img/light/alli/appIcon/alli-icon-copyrighting.svg';
import AlliIconCrew from '../../img/light/alli/appIcon/alli-icon-crew.svg';
import AlliIconEmail from '../../img/light/alli/appIcon/alli-icon-email.svg';
import AlliIconEvent from '../../img/light/alli/appIcon/alli-icon-event.svg';
import AlliIconGoodWord from '../../img/light/alli/appIcon/alli-icon-good-word.svg';
import AlliIconLaw from '../../img/light/alli/appIcon/alli-icon-law.svg';
import AlliIconManual from '../../img/light/alli/appIcon/alli-icon-manual.svg';
import AlliIconNoti from '../../img/light/alli/appIcon/alli-icon-noti.svg';
import AlliIconPrivacy from '../../img/light/alli/appIcon/alli-icon-privacy.svg';
import AlliIconPromotion from '../../img/light/alli/appIcon/alli-icon-promotion.svg';
import AlliIconPush from '../../img/light/alli/appIcon/alli-icon-push.svg';
import AlliIconSentence from '../../img/light/alli/appIcon/alli-icon-sentence.svg';
import AlliIconSlideNote from '../../img/light/alli/appIcon/alli-icon-slide-note.svg';
import AlliIconTranslator from '../../img/light/alli/appIcon/alli-icon-translator.svg';
import AlliIconWelcome from '../../img/light/alli/appIcon/alli-icon-welcome.svg';
